...
class TradingViewLikeInterface(QMainWindow):
    ...
    def initUI(self):
        ...
        self.short_sma_checkbox = QCheckBox("Показать короткую SMA")
        control_layout.addWidget(self.short_sma_checkbox)
        
        self.long_sma_checkbox = QCheckBox("Показать длинную SMA")
        control_layout.addWidget(self.long_sma_checkbox)
    ...
    def plot_chart(self):
        ...
        if data is not None:
            ...
            fig.add_trace(go.Bar(
                ...
                y=data['volume'],
                name='Volume',
                marker_color='rgba(204, 204, 255, 0.6)',
                yaxis='y2'
            ))

            # Добавление индикаторов, если они включены
            if self.short_sma_checkbox.isChecked():
            ...
            if self.long_sma_checkbox.isChecked():
